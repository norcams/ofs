...
keystone endpoint-create --service-id $(keystone service-list | awk '/neutron/ { print $2 }') --publicurl "http://192.168.166.12:9696" --internalurl "http://192.168.166.12:9696" --adminurl "http://172.16.188.12:9696" 
