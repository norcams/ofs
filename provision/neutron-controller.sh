...
keystone endpoint-create --service-id $(keystone service-list | awk '/neutron/ { print $2 }') --publicurl "http://192.168.166.12:9292" --adminurl "http://172.16.188.11:9292" --internalurl "http://172.16.199.12:9292"
