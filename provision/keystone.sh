...
keystone endpoint-create --service_id $(keystone service-list | awk '/keystone/ { print $2 }') --publicurl 'http://192.168.166.11:5000/v2.0' --internalurl 'http://192.168.166.11:5000/v2.0' --adminurl 'http://172.16.188.11:35357/v2.0' 
